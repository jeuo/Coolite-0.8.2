...
<script runat="server">
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Coolite.Ext.Web.Panel panel3 = new Coolite.Ext.Web.Panel();
        panel3.Header = false;
        panel3.BodyStyle = "padding:15px;";
        panel3.Html = "<p>Plain panel</p>";

        Coolite.Ext.Web.Panel panel4 = new Coolite.Ext.Web.Panel();
        ...
        Coolite.Ext.Web.Panel pnlTableLayout = new Coolite.Ext.Web.Panel();
        ...
        pnlTableLayout.BodyControls.Add(tableLayout1);
...
<head runat="server">
    <title>Simple TableLayout - Coolite Toolkit Examples</title>
