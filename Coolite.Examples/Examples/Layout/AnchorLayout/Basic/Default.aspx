...
<head runat="server">
    <title>AnchorLayout - Coolite Toolkit Examples</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <ext:ViewPort runat="server">
            <Body>
                <ext:AnchorLayout runat="server" Width="800" Height="600" >
                    <Anchors>
                        <ext:Anchor Horizontal="right" Vertical="20%">
                            <ext:Panel runat="server" Title="Item 1: right 20%" />
                        </ext:Anchor>
                        
                        <ext:Anchor Horizontal="50%" Vertical="30%">
                            <ext:Panel ID="Panel1" runat="server" Title="Item 2: 50% 30%" />
                        </ext:Anchor>
                        
                        <ext:Anchor Horizontal="-100" Vertical="50%">
                            <ext:Panel ID="Panel2" runat="server" Title="Item 3: -100 50%" />
                        </ext:Anchor>
                    </Anchors>
                </ext:AnchorLayout>
            </Body>
