...
<head id="Head1" runat="server">
    <title>KeyNav - Coolite Toolkit Example</title>
...
<body>
    ...
    <ext:Window ID="Window1" runat="server" Width="400" Height="300" Closable="false" Title="Move Window" BodyStyle="padding:6px;">
        <Body>
            <ul>
                <li>Press:</li>
                <li>&nbsp;&nbsp;UP</li>
