...
<script runat="server">
    ...
    {
        this.ScriptManagerProxy1.Listeners.DocumentReady.Handler = string.Format(
        ...
        this.ImageView.PrepareData.Fn = string.Concat("function(data){{ return ", this.ClientID, "_class.formatData(data);}}");
...
<ext:Window 
    ...
    <Buttons>
        ...
        <ext:Button runat="server" ID="CancelBtn" Text="Cancel" AutoPostBack="false" />
    </Buttons>
</ext:Window>