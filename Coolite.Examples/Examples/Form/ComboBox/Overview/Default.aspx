...
<head runat="server">
    <title>ComboBox - Coolite Toolkit Examples</title>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <ext:Button runat="server" AutoPostBack="false" Text="Set 'IDAHO' value">
            <Listeners>
        ...
        <h3>Editable with predefine value</h3>
