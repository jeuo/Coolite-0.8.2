...
<script runat="server">
    protected void Button1_Click(object sender, AjaxEventArgs e)
    {
        ...
        List<CheckboxGroup> groups1 = Coolite.Utilities.ControlUtils.FindControls<CheckboxGroup>(this.Page.Form);
        ...
        List<RadioGroup> groups2 = Coolite.Utilities.ControlUtils.FindControls<RadioGroup>(this.Page.Form);
            ...
            <Body>
                <ext:FitLayout ID="FitLayout1" runat="server">
                    <ext:TabPanel ID="TabPanel1" runat="server" ActiveTabIndex="0" Frame="true" DeferredRender="false">
                        <Tabs>
                            <ext:Tab ID="Tab1" runat="server" Title="Checkbox Groups" BodyStyle="padding:2px;">
                                <Body>
                            ...
                            <ext:Tab ID="Tab2" runat="server" Title="Radio Groups" BodyStyle="padding:2px;">
                                <Body>
