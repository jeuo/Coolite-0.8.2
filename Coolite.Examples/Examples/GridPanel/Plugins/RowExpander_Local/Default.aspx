...
<head id="Head1" runat="server">
    ...
    <script src="../../Shared/examples.js" type="text/javascript"></script>
        ...
        <ext:GridPanel ID="GridPanel1" runat="server" StoreID="Store1" TrackMouseOver="true"
            ...
            <Plugins>
                <ext:RowExpander ID="RowExpander1" runat="server" Collapsed="true">
                    <Listeners>
                        <BeforeCollapse Handler="Ext.example.msg('Row collapsing', 'Row № {0}', rowIndex);" />
                        <BeforeExpand Handler="Ext.example.msg('Row expanding', 'Row № {0}', rowIndex);" />
                        <Collapse Handler="Ext.example.msg('Row collapsed', 'Row № {0}', rowIndex);" />
                        <Expand Handler="Ext.example.msg('Row expanded', 'Row № {0}', rowIndex);" />
                    </Listeners>
