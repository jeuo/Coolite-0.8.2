...
<head id="Head1" runat="server">
    <title>GridPanel with MultiHeader Row Filters - Coolite Toolkit Examples</title>
            ...
            <Reader>
                <ext:ArrayReader>
                    <Fields>
                        ...
                        <ext:RecordField Name="lastChange" Type="Date" DateFormat="d/m/Y" />
                    </Fields>
                </ext:ArrayReader>
            </Reader>
        </ext:Store>
        ...
        <ext:GridPanel 
            ...
            <ColumnModel runat="server">
                <Columns>
                    ...
                    <ext:Column Header="Last Updated" Width="95" Sortable="true" DataIndex="lastChange">
                    ...
                    <HeaderRows>
                        <ext:HeaderRow>
                            <Columns>
                                ...
                                <ext:HeaderColumn Cls="x-small-editor">
                                    <Component>
                                        <ext:DateField ID="LastChangeFilter" runat="server" ReadOnly="true">
                                            <Listeners>
                                                <Select Handler="applyFilter();" />
                                            </Listeners>
                                        </ext:DateField>
