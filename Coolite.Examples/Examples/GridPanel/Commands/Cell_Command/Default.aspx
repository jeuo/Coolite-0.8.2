        ...
        <ext:GridPanel 
            ...
            <ColumnModel runat="server">
                <Columns>
                    ...
                    <ext:Column Header="Price" Width="100" Sortable="true" DataIndex="price" Align="Right" RightCommandAlign="false">
                    ...
                    <ext:Column Header="Change" Width="100" Sortable="true" DataIndex="change" Align="Right" RightCommandAlign="false">
                        <Renderer Fn="change" />
                        <Commands>
                            <ext:ImageCommand CommandName="Dollar" Icon="MoneyDollar" />
                            <ext:ImageCommand CommandName="Euro" Icon="MoneyEuro" />
                    ...
                    <ext:Column Header="Change" Width="75" Sortable="true" DataIndex="pctChange" Align="Right">
