    ...
    <ext:ViewPort runat="server">
        <Body>
            <ext:BorderLayout runat="server">
                <North>
                    <ext:Panel runat="server" Border="false" Height="120" BodyStyle="padding:6px;">
                        <Body>
                ...
                <Center>
                     <ext:GridPanel runat="server" ID="GridPanel1" Title="Suppliers" AutoExpandColumn="CompanyName"
                        ...
                        <Buttons>
                            <ext:Button runat="server" Text="Add" AutoPostBack="false" Icon="Add">
                                <Listeners>
                                    <Click Handler="var rowIndex = #{GridPanel1}.addRecord(); #{GridPanel1}.getView().focusRow(rowIndex); #{GridPanel1}.startEditing(rowIndex, 0);" />
                                </Listeners>
                            </ext:Button>
                            
                            <ext:Button runat="server" Text="Insert" AutoPostBack="false" Icon="Add">
                                <Listeners>
                            ...
                            <ext:Button runat="server" Text="Save" AutoPostBack="false" Icon="Disk">
                                <Listeners>
                                    <Click Handler="#{GridPanel1}.save();" />
                                </Listeners>
                            </ext:Button>
                            
                            <ext:Button runat="server" Text="Clear" AutoPostBack="false" Icon="Cancel">
                                <Listeners>
                                    <Click Handler="#{GridPanel1}.clear();if (!#{GridPanel1}.hasSelection()) {#{btnDelete}.disable();}" />
                                </Listeners>
                            </ext:Button>
                            
                            <ext:Button runat="server" Text="Refresh" AutoPostBack="false" Icon="ArrowRefresh">
                                <Listeners>
