        ...
        <ext:Button ID="Button1" runat="server" Text="Submit two grids">
            <AjaxEvents>
                <Click OnEvent="SubmitGrids">
                    <ExtraParams>
                        <ext:Parameter Name="Grid1" Value="Ext.encode(#{GridPanel1}.getRowsValues(false))" Mode="Raw" />
                        <ext:Parameter Name="Grid2" Value="Ext.encode(#{GridPanel2}.getRowsValues(false))" Mode="Raw" />
                    </ExtraParams>
                </Click>
            </AjaxEvents>
        </ext:Button>
