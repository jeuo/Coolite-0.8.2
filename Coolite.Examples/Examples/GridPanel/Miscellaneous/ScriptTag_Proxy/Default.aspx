...
<body>
    ...
    <ext:Store runat="server" ID="Store1" RemoteSort="true" AutoLoad="true">
        <Proxy>
            <ext:ScriptTagProxy Url="http://extjs.com/forum/topics-browse-remote.php" />
        </Proxy>
        <Reader>
            <ext:JsonReader Root="topics" TotalProperty="totalCount" ReaderID="threadid">
                <Fields>
    ...
    <ext:GridPanel 
		...
		<Columns>
            <ext:Column ColumnID="topic" Header="Topic" DataIndex="title" Width="420" Sortable="true">
                <Renderer Fn="template" />
            </ext:Column>
            <ext:Column Header="Author" DataIndex="author" Width="100" Hidden="true" Sortable="true" />
            <ext:Column Header="Replies" DataIndex="replycount" Width="70" Align="right" Sortable="true" />
            <ext:Column ColumnID="last" Header="Last Post" DataIndex="lastpost" Width="150" Sortable="true">
