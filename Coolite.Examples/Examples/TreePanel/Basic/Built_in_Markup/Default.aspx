...
<head id="Head1" runat="server">
    <title>Multi Node TreePanel built using markup - Coolite Toolkit Examples</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <ext:TreePanel ID="TreePanel1" runat="server" Width="300" Height="450" Icon="BookOpen" Title="Catalog" AutoScroll="true">
            ...
            <Listeners>
                <Click 
                    Handler="#{StatusBar1}.setStatus({text: 'Node Selected: <b>' + node.text + '</b>', clear: true});" 
                    />
                <ExpandNode 
                    Handler="#{StatusBar1}.setStatus({text: 'Node Expanded: <b>' + node.text + '</b>', clear: true});" 
                    Delay="30" 
                    />
                <CollapseNode 
                    Handler="#{StatusBar1}.setStatus({text: 'Node Collapsed: <b>' + node.text + '</b>', clear: true});" 
                    />
            </Listeners>
        </ext:TreePanel>
    </form>
