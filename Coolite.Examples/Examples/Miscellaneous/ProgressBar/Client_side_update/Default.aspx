...
<body>
    <form id="form1" runat="server">
        ...
        <p>            
            ...
            <ext:ProgressBar ID="Progress1" runat="server" Width="300" Text="Initializing..." Hidden="true"></ext:ProgressBar>
        </p>
        ...
        <p>
            ...
            <br />
            <ext:ProgressBar ID="Progress2" runat="server" StyleSpec="width:50%" Text="Ready" Cls="left-align"></ext:ProgressBar>
        </p>
