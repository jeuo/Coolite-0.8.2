...
<head runat="server">
    <title>Coolite Toolkit Example - Resizable</title>    
...
<body>
    <form id="form1" runat="server">
        ...
        <ext:Resizable ID="CustomResizer" runat="server" 
            Element="custom" 
            Wrap="true"
            Pinned="true"
            MinWidth="50"
        ...
        <ext:Panel ID="CooliteSite" runat="server" Width="400" Height="200" Cls="body-resizable">
            <AutoLoad Url="http://www.coolite.com" Mode="IFrame" />
        </ext:Panel>
        
        <ext:Resizable runat="server" 
            Element="={#{CooliteSite}.body}" 
            Width="400"
            Height="200"
            MinWidth="200"
            MinHeight="200"
