...
{
    public class FileUploadFieldAjaxEvents : TextFieldAjaxEvents
    {
        private ComponentAjaxEvent fileSelected;
        ...
        [ClientConfig("fileselected", typeof(AjaxEventJsonConverter))]
        ...
        public virtual ComponentAjaxEvent FileSelected
        {
            get
            {
                if (this.fileSelected == null)
                {
                    this.fileSelected = new ComponentAjaxEvent();
                }
