...
namespace Coolite.Ext.Web
{
    ...
    public class DataProxyListeners : ComponentBaseListeners
    {
        ...
        public ComponentListener BeforeLoad
        {
            get
            {
        ...
        public ComponentListener LoadException
        {
            get
            {
