...
namespace Coolite.Ext.Web
{
    ...
    /// </summary>
    [Xtype("datefield")]
    [InstanceOf(ClassName = "Ext.form.DateField")]
    ...
    [ToolboxBitmap(typeof(Coolite.Ext.Web.DateField), "Build.Resources.ToolboxIcons.DateField.bmp")]
    [Description("Provides a date input field with a DatePicker dropdown and automatic date validation.")]
    public class DateField : TriggerFieldBase, IAutoPostBack, IDate, IPostBackEventHandler, IPostBackDataHandler
    {
        ...
        private DateFieldAjaxEvents ajaxEvents;
        ...
        [ViewStateMember]
        public DateFieldAjaxEvents AjaxEvents
        {
            get
            {
                if (this.ajaxEvents == null)
                {
                    this.ajaxEvents = new DateFieldAjaxEvents();
        ...
        [DefaultValue("")]
        internal string AltFormatsProxy
        {
            get
            {
        ...
        [ClientConfig("maxValue", typeof(CtorDateTimeJsonConverter))]
        [Category("Config Options")]
        [Bindable(true)]
        ...
        [ClientConfig("minValue", typeof(CtorDateTimeJsonConverter))]
        [Category("Config Options")]
        [Bindable(true)]
        ...
        protected virtual void SetMinDate(DateTime minDate)
        {
            ...
            this.AddScript("{0}.setMinValue({1});", this.ClientID, JSON.Serialize(minDate.Date, converters));
        }
        ...
        protected virtual void SetMaxDate(DateTime maxDate)
        {
            ...
            this.AddScript("{0}.setMaxValue({1});", this.ClientID, JSON.Serialize(maxDate.Date, converters));
        }
    }
}