...
{
    public class BorderLayoutDesigner : WebControlDesigner
    {
        ...
        public override string GetDesignTimeHtml(DesignerRegionCollection regions)
        {
            ...
            if (northExists || this.SchemeMode)
            {
                ...
                if (northExists && ((this.layout.North.Items[0] is PanelBase) && (this.layout.North.Items[0] as PanelBase).Collapsed) && this.layout.North.Collapsible && !this.SchemeMode)
                {
                    ...
                    {
                        margins = string.Format("{0}px {1}px {2}px {3}px", marginsObj.Top, marginsObj.Right + (this.layout.West.Split ? 5 : 0), marginsObj.Bottom, marginsObj.Left);
                    }
                ...
                else
                {
                    if(northExists)
                    {
                        height = this.layout.North.Items[0] is BoxComponent ? ((BoxComponent)this.layout.North.Items[0]).Height : this.layout.North.Items[0].Height;
                    }
                    else
                    {
                    ...
                    if (!this.SchemeMode)
                    {
                        ...
                        margins = string.Format("{0}px {1}px {2}px {3}px", marginsObj.Top, marginsObj.Right, marginsObj.Bottom + (this.layout.North.Split ? 5 : 0), marginsObj.Left);
                        cell.Style["padding"] = margins;
                    }
            ...
            if (westExists || this.SchemeMode)
            {
                ...
                if (westExists && ((this.layout.West.Items[0] is PanelBase) && (this.layout.West.Items[0] as PanelBase).Collapsed) && this.layout.West.Collapsible && !this.SchemeMode)
                {
                    ...
                    {
                        margins = string.Format("{0}px {1}px {2}px {3}px", marginsObj.Top, marginsObj.Right + (this.layout.West.Split ? 5 : 0), marginsObj.Bottom + 2, marginsObj.Left);
                    }
                ...
                else
                {
                    if(westExists)
                    {
                        cell.Width = this.layout.West.Items[0] is BoxComponent ? ((BoxComponent)this.layout.West.Items[0]).Width : this.layout.West.Items[0].Width;
                    }
                    else
                    {
                    ...
                    if (!this.SchemeMode)
                    {
                        ...
                        margins = string.Format("{0}px {1}px {2}px {3}px", marginsObj.Top, marginsObj.Right + (this.layout.West.Split ? 5 : 0), marginsObj.Bottom + addBottomMargins, marginsObj.Left);
                        cell.Style["padding"] = margins;
                    }
            ...
            if (!this.SchemeMode)
            {
                ...
                margins = string.Format("{0}px {1}px {2}px {3}px", marginsObj.Top, marginsObj.Right, marginsObj.Bottom + addBottomMargins, marginsObj.Left);
                cell.Style["padding"] = margins;
            }
            ...
            if (eastExists || this.SchemeMode)
            {
                ...
                else
                {
                    if(eastExists)
                    {
                        cell.Width = this.layout.East.Items[0] is BoxComponent ? ((BoxComponent)this.layout.East.Items[0]).Width : this.layout.East.Items[0].Width;
                    }
                    else
                    {
                        cell.Width = Unit.Pixel((int)(table.Width.Value * 0.2));
                    ...
                    if (!this.SchemeMode)
                    {
                        ...
                        margins = string.Format("{0}px {1}px {2}px {3}px", marginsObj.Top, marginsObj.Right, marginsObj.Bottom + addBottomMargins, marginsObj.Left + (this.layout.East.Split ? 5 : 0));
                        cell.Style["padding"] = margins;
                    }
            ...
            if (southExists || this.SchemeMode)
            {
                ...
                else
                {
                    if(southExists)
                    {
                        height = this.layout.South.Items[0] is BoxComponent ? ((BoxComponent)this.layout.South.Items[0]).Height : this.layout.South.Items[0].Height;
                    }
                    else
                    {
                        height = new Unit((int)(table.Height.Value * 0.3), table.Height.Type);
                    ...
                    if (!this.SchemeMode)
                    {
                        ...
                        margins = string.Format("{0}px {1}px {2}px {3}px", marginsObj.Top + (this.layout.South.Split ? 5 : 0), marginsObj.Right, marginsObj.Bottom, marginsObj.Left);
                        cell.Style["padding"] = margins;
                    }
            ...
            //writer.Write(
            //    sb.ToString().Trim().Replace(Environment.NewLine, string.Empty).Replace("\n", string.Empty).Replace(
            //        "\t", string.Empty).Replace("id=\"" + this.ClientID + "\"", "id=\"" + this.ContainerID + "\""));
